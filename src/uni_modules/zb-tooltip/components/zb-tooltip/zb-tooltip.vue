<template>
	<view class="zb-tooltip" :style="{
		...
		<view :style="theme" class="zb_tooltip_content" @click.stop="handleClick">
			<slot></slot>
...
<style lang="scss" scoped>
	...
	.zb_popper__arrow {
		...
		border-top: 6px solid $thcz-back-btn-bg-color;
	...
	.zb_popper__right {
		...
		border-right: 6px solid $thcz-back-btn-bg-color;
		left: -5px;
	}
	...
	.zb_popper__left {
		border-top: 6px solid transparent;
		border-bottom: 6px solid transparent;
		border-left: 6px solid $thcz-back-btn-bg-color;
		right: -5px;
	}
	...
	.zb_popper__up {
		border-left: 6px solid transparent;
		border-right: 6px solid transparent;
		border-bottom: 6px solid $thcz-back-btn-bg-color;
		top: -5px;
	}
