<template>
	<view :style="theme" class="u-wrap page_boxs">
				...
				<view class="page-view">
					<view class="class-item" :id="'item' + index" v-for="(item , index) in tabbar" :key="index">
						...
						<view class="item-container">
							<view class="thumb-box" v-for="(item1, index1) in item.vendors" :key="index1">
	...
	export default {
		...
		methods: {
			...
			async getVlistAll() {
				...
				console.log('左边分类',newList)
				that.tabbar = newList
				//that.classID = newList[0].id
				//this.GetGameslsit(newList[0].id)
			},
			//获取热门游戏
			async GetHotGames(){
				let that = this
