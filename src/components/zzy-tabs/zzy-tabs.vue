<template>
	<view class="u-tabs" :style="{ background: bgColor }">
		...
		<view :style="theme" style="position: relative;">
			<scroll-view scroll-x class="u-scroll-view" :scroll-left="scrollLeft" scroll-with-animation>
				...
				<view class="u-scroll-box" :id="id" :class="{'u-tabs-scroll-flex': !isScroll}">
					...
					<view class="u-tab-item u-line-1" :id="'u-tab-item-' + index" v-for="(item, index) in list" :key="index" @tap="clickTab(index)" :style="[tabItemStyle(index)]">
						...
						<view class="tabs_icon" :class="[current == index?'xzbgtu':'']">
							
							<image class="moren" :src="domains + '/vendorIcon/' + item.name + '.png'" mode="widthFix"></image>
...
<script>
	 ...
	 * @example <zzy-tabs ref="tabs" :list="list" :is-scroll="false"></zzy-tabs>
	 */
	export default {
		name: "zzy-tabs",
		props: {
