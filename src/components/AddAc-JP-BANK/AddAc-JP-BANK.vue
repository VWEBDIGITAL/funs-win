			...
			<view class="input_box">
				...
				<view class="input_item">
					...
					<view class="input_item_true" :class="input_border1 == 1?'input_border':''">
						<u-input v-model="XingMing" @input="input1" @blur="inputBlur1" @focus="inputfocus1" type="text" :border="false" :custom-style="customStyle" :placeholder-style="placeholderStyle" placeholder="" :clearable="false" />
					</view>
				</view>
				...
				<view class="input_item">
					...
					<view class="input_item_true" :class="input_border2 == 1?'input_border':''">
						<u-input v-model="KaHao" @input="input2" @blur="inputBlur2" @focus="inputfocus2" type="number" :border="false" :custom-style="customStyle" :placeholder-style="placeholderStyle" placeholder="" :clearable="false" />
					</view>
				</view>
				
				<view class="input_item">
					<view class="input_item_title">支行 *</view>
					<view class="input_item_true" :class="input_border3 == 1?'input_border':''">
						<u-input v-model="ZhiHang" @input="input3" @blur="inputBlur3" @focus="inputfocus3" type="text" :border="false" :custom-style="customStyle" :placeholder-style="placeholderStyle" placeholder="" :clearable="false" />
					</view>
				</view>
...
<script>
	import BankData from "@/utils/JPbankList.js";
			...
			Baocun() {
				...
				if (this.XingMing == "") {
					...
					that.$u.post('/withdraw/bind', {
						method: 21, // number 是 绑定渠道类型
						
						phoneNum: '', // String 否 手机号码 格式：(+00)186123
						email: that.ZhiHang, // String 否 电子邮件
						
						deviceId: serialNo,
						deviceType: machineName || ua,
						
						account: that.KaHao, //帐号
						realName: that.XingMing, //户名
						...
						that.KaHao = ""
						that.ZhiHang = ""
						that.isbnakCode = "23000"
						that.isbnakName = "AEON"
