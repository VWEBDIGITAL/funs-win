<template>
	<view :style="theme">
		...
		<view class="u-loading-hot" v-show="loadingtrue == true">
			<view class="loader">
		...
		<view class="shopTuijian" v-show="loadingtrue == false">
			<view class="uni-swiper-tab" v-if="HotGameList.length != 0">
				<u-row gutter="20">
					<u-col :span="colSpan" v-for="(val,indexb) in HotGameList" :key="indexb">
						<view class="scrollx_items">
							<view class='jrsx_item2'>
								<view class='goodsdetail'>
									...
									<view class='jrsx_title'>
										<view class="title">{{val.gameName}}</view>
									</view>
								</view>
							</view>
						</view>
				...
				<view class="more-progress">
					<u-line-progress :percent="Moreprogress(totalCount,HotGameList.length)" height="6" active-color="#2979ff" inactive-color="#9399ad" :show-percent="false">
						<view slot="default"></view>
					</u-line-progress>
				</view>
				<view class="tongji_box" :class="isNomoreHot == 1?'jianju':''">
					<!--Displaying {{HotGameList.length}} of {{totalCount}} games-->
					{{$t('prompt', {c: totalCount,l:HotGameList.length})}}
				</view>
				
				<view class="more_btn" v-if="isNomoreHot == 0">
