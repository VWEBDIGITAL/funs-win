		...
		<u-popup v-model="RegiserShow" width="650" mode="center" close-icon-size="30" border-radius="14" :mask-close-able="false" :closeable="true">
			...
			<view class="page_wrap">
				<view class="reg_title" @click="RegiserShow = false">
					<view>{{$t('signInPopup.ForgotPassword')}}</view>
				</view>
				<view class="input_box">
					...
					<view class="input_item">
						...
						<view class="input_item_true" v-if="vType == 1" :class="input_border1 == 1?'input_border':''" style="padding: 0 16rpx 0 0;">
							<view class="quhao_box">
								<view class="quhao" style="padding: 0 15rpx 0 0;">
									<view>
