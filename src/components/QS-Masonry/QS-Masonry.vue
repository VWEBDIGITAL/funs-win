		...
		<view class="QS-Masonry-container">
			<view class="col-container" v-for="(item, index) in getCol" :key="lists[index].id">
				<view class="col-container-item" :style="{ width: getColWidth }">
					<QSMasonryTemplate ref="QSMasonryTemplate" :type="type" :list="lists[index].list || []" :itemSpace="itemSpace" @clickItems="clickItems"></QSMasonryTemplate>
				</view>
				<view class="colSpace" :style="{ width: colSpace + 'px' }"></view>
			</view>
			<view class="QS-hide-template" :style="{ width: getColWidth }">
				<QSMasonryTemplate ref="QSMasonryHideTemplate" hideTem :hasImage="hasImage" :type="type" @clickItems="clickItems"></QSMasonryTemplate>
			</view>
		</view>
	</view>
</template>
...
<script>
    ...
    const { isArray } = require('./js/QS-Utils.js');
