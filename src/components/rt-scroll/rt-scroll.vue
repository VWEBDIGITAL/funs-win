<template>
	<view :style="theme" class="nav-box">
		<scroll-view scroll-x="true" @scroll="scroll" class="scroll-view" bounces="true" show-scrollba="false" enhanced="true" scroll-anchoring="true">
			<view :class="styleType == 1 ? 'navF':'navG'" :style="styleType == 2 ? `grid-template-rows: repeat(${rows}, 1fr);` : ''">
				<slot></slot>
			</view>
		</scroll-view>
