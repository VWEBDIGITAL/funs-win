		...
		>
			<view class="u-mode-center-box" @tap.stop.prevent @touchmove.stop.prevent v-if="mode == 'center'" :style="[centerStyle]">
				<u-icon
					...
					:size="closeIconSize"
				></u-icon>
				<view class="u-drawer__scroll-view" scroll-y="false">
					<slot />
				</view>
			</view>
			<view class="u-drawer__scroll-view" scroll-y="false" v-else>
				<slot />
			</view>
 ...
 * @example <zp-popup v-model="show"><view>出淤泥而不染，濯清涟而不妖</view></zp-popup>
 */
export default {
	name: 'zp-popup',
	props: {
