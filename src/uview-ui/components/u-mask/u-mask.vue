<template>
	<view class="u-mask" hover-stop-propagation :style="[theme,maskStyle, zoomStyle]" @tap="click" @touchmove.stop.prevent="() => {}" :class="{
		'u-mask-zoom': zoom,
		'u-mask-show': show
	}">
		<slot />
...
<style lang="scss" scoped>
	...
	.u-mask {
		...
		//background-color: $uniMask-bg-color !important;
	}
