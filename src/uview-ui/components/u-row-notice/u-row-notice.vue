	...
	>
		<view class="u-direction-row">
			<view class="u-icon-wrap">
				<u-icon class="u-left-icon" v-if="volumeIcon" name="volume-fill" :size="volumeSize" ></u-icon><!--:color="computeColor"-->
			</view>
			...
			<view class="u-icon-wrap">
				<u-icon @click="getMore" class="u-right-icon" v-if="moreIcon" name="arrow-right" :size="26" ></u-icon>
				<u-icon @click="close" class="u-right-icon" v-if="closeIcon" name="close" :size="24" ></u-icon>
			</view>
		</view>
	</view>
</template>
...
.u-left-icon {
	...
	/* #endif */
	align-items: center;
	color: $notice-font-color !important;
}
