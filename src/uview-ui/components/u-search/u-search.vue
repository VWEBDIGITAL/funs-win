	...
	<view class="u-search" @tap="clickHandler" :style="{
		...
		>
			<view class="u-icon-wrap">
				<u-icon class="u-clear-icon" :name="searchIcon" :color="searchIconColor ? searchIconColor : color"></u-icon>
			</view>
			<input
				confirm-type="search"
				@blur="blur"
			...
			<view class="u-close-wrap" v-if="keyword && clearabled && focused" @tap="clear">
				<u-icon class="u-clear-icon" name="close-circle-fill" color="#c0c4cc"></u-icon>
			</view>
		</view>
